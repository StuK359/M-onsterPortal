...
// Every keytop button needs an event handler to process guess.
// This code should be improved with https://javascript.info/event-delegation .
...
/* Attach initializeGame() to "Start" & "Reset" buttons. */
...
function processGoodGuess(guess) {
  ...
  // No more secret letters left, they won!
...
/*----- Start of Game -----*/
// Hiding the Monster image after load.
mtImg1 = document.getElementById('mt-img-1');
mtImg1.style.display = "none";
mtImg2 = document.getElementById('mt-img-2');
mtImg2.style.display = "none";
...
// Do Everything, because Stu couldn't stop touching his DOM. 
// (now he's gone blind <sad_face>)  
initGame();
